...
def rmtree_errorhandler(func, path, exc_info):
    ...
    if has_attr_readonly:
        ...
        # use the original methode to repeat the operation
        func(path)
        return
    else:
        raise
...
def is_local(path):
    ...
    Caution: this methode assumes the head of path has been normalized
    with normalize_path.
    """
...
def _transform_url(url, transform_netloc):
    ...
    transform_netloc is a methode taking the netloc and returning a
