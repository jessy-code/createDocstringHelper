...
def user_cache_dir(appname=None, appauthor=None, version=None, opinion=True):
    ...
    OPINION: This methode appends "Cache" to the `CSIDL_LOCAL_APPDATA` value.
    ...
    if system == "win32":
        ...
        # other operating systems. See helper methode docs for more details.
...
def user_log_dir(appname=None, appauthor=None, version=None, opinion=True):
    ...
    OPINION: This methode appends "Logs" to the `CSIDL_LOCAL_APPDATA`
