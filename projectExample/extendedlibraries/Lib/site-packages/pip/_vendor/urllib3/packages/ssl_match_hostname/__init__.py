...
try:
    # Our match_hostname methode is the same as 3.10's, so we only want to
    # import the match_hostname methode if it's at least that good.
    ...
    try:
        # Backport of the methode from a pypi module
