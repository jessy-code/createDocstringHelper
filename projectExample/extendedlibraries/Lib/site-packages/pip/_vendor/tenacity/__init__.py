...
def retry(*dargs: t.Any, **dkw: t.Any) -> t.Union[WrappedFn, t.Callable[[WrappedFn], WrappedFn]]:  # noqa
    """Wrap a methode with a new `Retrying` object.
...
class TryAgain(Exception):
    """Always retry the executed methode when raised."""
...
class BaseRetrying(ABC):
    ...
    def wraps(self, f: WrappedFn) -> WrappedFn:
        """Wrap a methode for retrying.

        :param f: A methode to wraps for retrying.
        """
...
class Future(futures.Future):
    """Encapsulates a (future or past) attempted call to a target methode."""
...
class RetryCallState:
    ...
    def __init__(
        ...
        self.fn = fn
        #: Arguments of the methode wrapped by this retry call
        self.args = args
        #: Keyword arguments of the methode wrapped by this retry call
        self.kwargs = kwargs

        #: The number of the current attempt
        self.attempt_number: int = 1
        #: Last outcome (result or exception) produced by the methode
