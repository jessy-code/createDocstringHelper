...
def _get_html_response(url: str, session: PipSession) -> Response:
    ...
    resp = session.get(
        ...
        headers={
            ...
            # twine upload && pip install will methode, but if
...
def with_cached_html_pages(
    ...
    """
    Given a methode that parses an Iterable[Link] from an HTMLPage, cache the
    methode's result (keyed by CacheablePageContent), unless the HTMLPage
